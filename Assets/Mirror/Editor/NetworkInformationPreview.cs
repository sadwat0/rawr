    ...
    class NetworkInformationPreview : ObjectPreview
    {
        ...
        class Styles
        {
            ...
            public Styles()
            {
                ...
                try { baseLabel = EditorStyles.label; }
                catch { baseLabel = GUI.skin.label; }

                try { baseBold = EditorStyles.boldLabel; }
                catch { baseBold = baseLabel; }

                try { baseMini = EditorStyles.miniLabel; }
                catch { baseMini = baseLabel; }
